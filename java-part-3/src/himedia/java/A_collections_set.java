...
// Set 인터페이스를 구현하는 대표적인 클래스에는 HashSet, TreeSet, LickedHashSet 등이 있다.
// Set은 요소의 순서를 보장하지 않으며, 각 요소는 고유하다.

// * 주요 특징
// - 중복 허용 안함 : Set은 동일한 요소가 두 번 이상 포함될 수 없다.
// - 순서 보장 안됨 : 일반적으로 요소의 삽입 순서를 보장하지 않지만, 일부 구현체(LickedHashSet)는 순서를 유지할 수 있다.
...
public class A_collections_set {
    ...
    // 1. HashSet
    // - 해시 기반 : HashSet은 내부적으로 HashMap을 사용하요 요소를 저장한다.
    // - 빠른 성능 : 요소의 추가, 삭제, 검색 속도가 빠르다. 시간복잡도 : 0(1)
    ...
    public static void exam1(){
        ...
        System.out.println("Does set contains Apple ? : " + result);
    ...
    public static void exam2(){
        ...
        System.out.println("HashSet 1 : " + treeSet);
        treeSet.add("Apple");
        System.out.println("HashSet 2 : " + treeSet);
