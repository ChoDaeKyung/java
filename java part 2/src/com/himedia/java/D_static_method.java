package com.himedia.java;
    ...
    // 인스턴스 변수나 인스턴스 메서드에는 집적 접근할 수 없다.
    // 3. 유틸리티 메서드로 자주 사용
    ...
    // - 주로 유틸리티 성격의 메서드나, 클래스 자체의 특성과 관련된 기능을 제공하는 메서즈를 정의할 때 사용한다.
    // - 인스턴스 변수를 사용하지 않고, 클래스 차원레서 공통으로 사용할 수 있는 기능을 제공할 때 유용하다.
...
public class D_static_method {
    public static void main(String[] args) {
        ...
        // 호출
        // 출력
        double add = D_calc.add(2,3);
        System.out.println(add);
        System.out.println(D_calc.add(2,3));
        // multi
        // 호출
        // 출력
        System.out.println(D_calc.multi(2,3));
        // circleArea
        // 호출
        // 출력
        System.out.println(D_calc.circleArea(3));

//        D_calc.minus Minus() = new D_calc.Minus();
